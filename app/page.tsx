        ...
        <div className="max-w-6xl mx-auto space-y-4 sm:space-y-8">
          ...
          <div className="grid gap-4 sm:gap-8 lg:grid-cols-[400px_1fr]">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              {income > 0 && (
                <div className="rounded-lg border border-border/50 bg-card p-3 sm:p-4 space-y-2 hidden lg:block">
                  <h3 className="text-sm font-medium text-muted-foreground">Quick Reference</h3>
            ...
            <div className="space-y-4 sm:space-y-6">
              {!hasCalculated ? (
                <div className="flex flex-col items-center justify-center min-h-[250px] sm:min-h-[400px] rounded-lg border border-dashed border-border bg-muted/20 text-center p-4 sm:p-8">
                  ...
                  <h2 className="text-base sm:text-lg font-semibold text-foreground mb-2">Ready to Calculate</h2>
